...
class MapViewController: UIViewController {
    ...
    func showInfo(){
     ...
     func showMessage(type: MapMessageType){
        ...
        let message = type == .authorizationWarning ? "Para usar os recursos de localização do App, você precisa permitir o uso na tela de Ajustes" : "Não foi possivel encontrar essa rota"
