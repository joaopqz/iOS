...
extension RemoteAuthenticationTests{
    ...
    func expect(_ sut: RemoteAuthentication, completeWith expectedResult: Result<Authentication.Result, DomainError>, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line){
